...
This guide will explain step by step how to install Open Classifieds on [Digital Ocean](https://www.digitalocean.com/?refcode=ebff5f6941b0)
...
# <a name="vultr"></a>[How to install Open Classifieds on VULTR](http://www.vultr.com/?ref=6814237)

## Introduction

Open Classifieds is an Open Source (GPL v3) project that lets you easily create your own fully customizable classifieds site. OC can be used to create car/auto sales, job search board, buying & selling real estate and almost anything you can think of. Thousands of web developers trust Open Classifieds to run their big classifieds websites.

This guide will explain step by step how to install Open Classifieds on [VULTR](http://www.vultr.com/?ref=6814237)
...
# <a name="linode"></a>How to install Open Classifieds on [Linode](https://www.linode.com/)
